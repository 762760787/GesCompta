...
<body>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <div class="app-brand demo ">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">GESCOMPT</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div class="text-truncate" data-i18n="Authentications">Journale</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="auth-login-basic.html" class="menu-link">
                                    <div class="text-truncate" data-i18n="Basic">Journale Transactions</div>
                                </a>
                            </li>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            ".menu-item > a"); // Sélectionne tous les liens directs du menu

            // Récupérer l'élément actif depuis localStorage
            ...
            if (activeMenu) {
                document.querySelectorAll(".menu-item").forEach(item => {
                    ...
                    if (link && link.getAttribute("href") === activeMenu) {
                        ...
                        let parent = item.closest(".menu-item"); // Vérifie si c'est un sous-menu
                        if (parent) {
            ...
            menuItems.forEach(link => {
                link.addEventListener("click", function(e) {
                    let menuItem = this.parentElement; // L'élément <li> parent du lien

                    // Supprimer l'ancienne classe active pour tous les items
