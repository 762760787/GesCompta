    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row g-6 mb-6">
                <div class="col-md-8">
                    <div class="card">
                        <h5 class="card-header">Modifier Dépense</h5>
                        <div class="card-body">
                            <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" class="browser-default-validation">
                                @csrf
                                ...
                                <input type="hidden" name="id" value="{{ $transaction->id }}"> {{-- Champ caché pour l'ID --}}
