            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    ...
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1">Bienvenue à Sneat ! 👋</h4>
                        <p class="mb-6">Veuillez vous connecter à votre compte et commencer l'aventure</p>

                        <form id="formAuthentication" class="mb-6" action="{{ route('login.handleLogin') }}" method="POST">
                            @csrf
                            <div class="mb-6">
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100 mt-1">Se Connecter</button>
                        </form

                        <p class="text-center">
                            <span>Nouveau sur L' appli' ?</span>
